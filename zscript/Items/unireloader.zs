class HDUniversalReloader : HDWeapon
{
	...
	override void BeginPlay()
	{
		...
		if (r = HDRel_Recipe.TryCreate("HDNDMLoose",          "HDRel_RawLead", 4, 2.75,   "HDRel_RawPlastic", 1, 0.75,   "HDRel_RawPowder", 2, 1.00,    1.00)) Recipes.Push(r); // Guillotine, peppergrinder.pk3
